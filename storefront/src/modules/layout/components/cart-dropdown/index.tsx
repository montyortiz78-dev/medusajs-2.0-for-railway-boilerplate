    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <Popover.Panel
            static
            className="hidden small:block absolute top-[calc(100%+1px)] right-0 bg-white border-x border-b border-gray-200 w-[420px] text-ui-fg-base shadow-xl rounded-b-lg"
          ...
          >
            ...
            {cartState && cartState.items?.length ? (
              <>
                            ...
                            <div className="flex flex-col flex-1">
                              <div className="flex items-start justify-between">
                                <div className="flex flex-col overflow-ellipsis whitespace-nowrap mr-4 w-[180px]">
                                  <h3 className="text-base-regular overflow-hidden text-ellipsis font-semibold">
                                    <LocalizedClientLink
                                      href={`/products/${item.variant?.product?.handle}`}
                                  ...
                                  {/* VIBE SUBTITLE */}
                                  {kandiVibe && (
                                    <span className="text-xs text-ui-fg-subtle italic truncate block mb-1">
                                      "{kandiVibe}"
                                    </span>
                                  )}

                                  {/* HIDE VARIANT IF KANDI */}
                                  {!kandiName && (
                                    <LineItemOptions
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular border-t border-gray-100 bg-gray-50">
                  <div className="flex items-center justify-between">
                    <span className="text-ui-fg-base font-semibold">
                      Subtotal{" "}
                      <span className="font-normal text-ui-fg-muted">(excl. taxes)</span>
                    </span>
                    <span
